...
__access_key = 'e2bf2749484140fb9a00feb96f76fa67'

def getUrl(date):
    base = 'https://openexchangerates.org/api/historical/'
    return base+date+'.json?app_id='+__access_key
...
def plot(dateArray):
    plt.xlabel('Date')
    plt.ylabel('Rate')
    plt.title('Stock Analysis Of USD to INR')
    ...
    plt.plot(x, y1, 'go:', label='2017-03-01 TO 2017-03-30')
...
plot(genDate('2017-03-01','2017-03-30'))
